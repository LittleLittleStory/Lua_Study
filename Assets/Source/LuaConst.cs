...
{
    public static string luaDir = Application.streamingAssetsPath + "/Win/game_lua";               //lua逻辑代码目录
    public static string toluaDir = Application.streamingAssetsPath + "/ToLua/Lua";        //tolua lua文件目录
